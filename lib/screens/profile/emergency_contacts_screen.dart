...
class _EmergencyContactsScreenState extends State<EmergencyContactsScreen> {
  ...
  Future<void> _loadContacts() async {
    ...
    final loadedContacts = await _contactService.getEmergencyContacts();
          ...
          TextButton(
            onPressed: () async {
              ...
              try {
                ...
                _showError('Failed to delete contact: ${e.toString()}');
              } finally {
                setState(() {
                  _isLoading = false;
                });
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      body: RefreshIndicator(
        ...
        child: _isLoading && contacts.isEmpty
