...
class _ProfileScreenState
  ...
  final _vehicleColorController =
  TextEditingController();

  final _vehiclePlateController =
  TextEditingController();

  final _vehicleSeatsController =
  TextEditingController();
  ...
  void _populateControllers() {
    ...
    _vehicleSeatsController.text =
        _user!.vehicleSeats.toString();
  }
  ...
  void didChangeDependencies() {
    ...
    if (ProfileScreen
        .shouldSwitchToDriver &&
        _user != null &&
        !_user!.isDriver) {

      ProfileScreen
          .shouldSwitchToDriver = false;
